...
export default async function decorate(block) {
  ...
  if (!isSingleSlide) {
    ...
    slideNavButtons.innerHTML = `
      <button type="button" class="slide-prev" aria-label="${placeholders.previousSlide || 'Previous Slide'}">${placeholders.previousSlide || 'Previous Slide'}</button>
      <button type="button" class="slide-next" aria-label="${placeholders.nextSlide || 'Next Slide'}">${placeholders.nextSlide || 'Next Slide'}</button>
    `;
